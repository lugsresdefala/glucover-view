...
// Tipos de ajuste de insulina para a calculadora
export type InsulinAdjustmentType = 
  | "NPH_NOTURNA" 
  | "NPH_MANHA" 
  | "NPH_ALMOCO"
  | "NPH_JANTAR" 
...
// Resultado de ajuste estruturado para a calculadora
...
export interface ClinicalRecommendation {
  ...
  // Dados estruturados para calculadora de insulina
  ajustesRecomendados?: InsulinAdjustment[];
}
